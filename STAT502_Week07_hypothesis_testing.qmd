...
keyboards) means "is a function of"].  We see that it is not
immediately clear whether or not the treatments are effective.  To
answer this, we consider a null hypothesis $H_0$ which is that the
